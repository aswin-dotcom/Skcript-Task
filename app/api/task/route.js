        ...
        cards: [
          ...
          },
          {
            ...
            content:
              ...
              description:"AWS (Amazon Web Services) is a cloud computing platform that provides various services like computing power, storage, networking, databases, AI/ML, DevOps tools, and more.",
            label: "Design",
            Date: "2023-06-30",
            upvotes: 9,
            status: "Planned",
          ...
          },
          {
            ...
            content:
              ...
              description:".NET is a cross-platform framework by Microsoft for building web, desktop, cloud, mobile, gaming, and IoT applications.",
            label: "Design",
            Date: "2023-06-30",
            upvotes: 9,
            status: "Planned",
      ...
      },
      {
        ...
        cards: [
          ...
          },
          {
            id: generateUUID(),
            content: "Azure",
            description:"Azure offers multiple ways to deploy applications, depending on your project needs. Since you're working with .NET and Angular, here are common deployment methods for both frontend and backend",
            label: "Documentation",
            Date: "2023-07-10",
            upvotes: 5,
            status: "In Progress",
      ...
      },
      {
        ...
        cards: [
          ...
          },
          {
            ...
            description:"Azure DevOps is a set of cloud-based tools provided by Microsoft to manage the software development lifecycle. It includes services like Azure Repos (Git version control), Azure Pipelines (CI/CD automation), Azure Boards (project management), Azure Test Plans (testing), and Azure Artifacts (package management). It helps teams collaborate efficiently and automate deployments. ",
            label: "Setup",
            Date: "2023-06-25",
            upvotes: 8,
            status: "Completed",
          ...
          },
          {
            ...
            description:"Microservices is an architectural style where an application is broken down into smaller, independent services that communicate through APIs. Each service handles a specific business function and can be deployed, scaled, and updated independently. This approach improves scalability, fault isolation, and flexibility compared to monolithic applications. ",
            label: "Setup",
            Date: "2023-06-25",
            upvotes: 8,
            status: "Completed",
